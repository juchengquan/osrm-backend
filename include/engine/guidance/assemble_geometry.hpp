                                    ...
                                    const bool reversed_target)
{
    ...
    const auto source_segment_start_node = source_geometry(source_segment_start_coordinate);
    geometry.osm_node_ids.push_back(
        facade.GetOSMNodeIDOfNode(source_segment_start_node));
    // add coordinates
    // geometry.locations.push_back(facade.GetCoordinateOfNode(source_segment_start_node));
    ...
    const auto target_segment_end_node = target_geometry(target_segment_end_coordinate);
    geometry.osm_node_ids.push_back(
            facade.GetOSMNodeIDOfNode(target_segment_end_node));
    // geometry.locations.push_back(facade.GetCoordinateOfNode(target_segment_end_node));
...
inline LegGeometry assembleGeometryNew(const datafacade::BaseDataFacade &facade,
                                    const std::vector<PathData> &leg_data,
                                    const PhantomNode &source_node,
                                    const PhantomNode &target_node,
                                    const bool reversed_source,
